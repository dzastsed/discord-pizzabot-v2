...
async def on_message(msg):
    global initDone
    if msg.author.bot and not msg.author.id == 849689355773018192 and not msg.author.id == 836229796509384714 or not initDone:
        return
        ...
        async with msg.channel.typing():
            ...
            try:
                    ...
                    if message != '':
                        ...
                        #await msg.channel.send(message) kingsadra
                        return
            except:
                pass
